...
document.getElementById("dean-name").textContent = KIRK_Dean.name;
document.getElementById("dean-title").textContent = KIRK_Dean.title;
document.getElementById("dean-department").textContent = KIRK_Dean.department;
document.getElementById("dean-photo").src = KIRK_Dean.photo;
document.getElementById("dean-phone").href = "tel:" + KIRK_Dean.phone;
document.getElementById("dean-phone").lastChild.textContent = KIRK_Dean.contact;
document.getElementById("dean-email").href = "mailto:" + KIRK_Dean.email;
document.getElementById("dean-email").lastChild.textContent = KIRK_Dean.email;
document.getElementById("dean-website").href = KIRK_Dean.website;
document.getElementById("dean-website").lastChild.textContent = KIRK_Dean.website;
document.getElementById("dean-message").textContent = KIRK_Dean.message;

const deanMessage = KIRK_Dean.message.split('\n').map(paragraph => `<p>${paragraph}</p>`).join('');

document.getElementById("dean-message").innerHTML = deanMessage;



document.getElementById("intro-text").textContent = KIRK_Intro;

document.getElementById("vision-title").textContent = KIRK_Overview.vision.title;
document.getElementById("vision-text").textContent = KIRK_Overview.vision.text;
document.getElementById("vision-image").src = KIRK_Overview.vision.image;

document.getElementById("objectives-title").textContent = KIRK_Overview.objectives.title;
const objectivesList = document.getElementById("objectives-list");
KIRK_Overview.objectives.list.forEach((item) => {
    const li = document.createElement("li");
    li.textContent = item;
    objectivesList.appendChild(li);
});
document.getElementById("objectives-image").src = KIRK_Overview.objectives.image;

document.getElementById("mission-title").textContent = KIRK_Overview.mission.title;
document.getElementById("mission-text").textContent = KIRK_Overview.mission.text;
document.getElementById("mission-image").src = KIRK_Overview.mission.image;
...
function createStaffCards(staffData, containerId) {
  ...
  createStaffCards(KIRK_Admin, "kirkAdmin");
  createStaffCards(KIRK_Academic, "kirkAcademic");
...
boxes.forEach(box => {
  box.addEventListener('click', () => {
    ...
    const correspondingCourses = KIRK_Courses.filter(course => course.label === boxLabel);
...
document.querySelector('.courses-table tbody').innerHTML = generateTableRows(KIRK_Courses);
