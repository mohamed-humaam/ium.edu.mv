...
document.getElementById("dean-name").textContent = KED_Dean.name;
document.getElementById("dean-title").textContent = KED_Dean.title;
document.getElementById("dean-department").textContent = KED_Dean.department;
document.getElementById("dean-photo").src = KED_Dean.photo;
document.getElementById("dean-phone").href = "tel:" + KED_Dean.phone;
document.getElementById("dean-phone").lastChild.textContent = KED_Dean.contact;
document.getElementById("dean-email").href = "mailto:" + KED_Dean.email;
document.getElementById("dean-email").lastChild.textContent = KED_Dean.email;
document.getElementById("dean-website").href = KED_Dean.website;
document.getElementById("dean-website").lastChild.textContent = KED_Dean.website;
document.getElementById("dean-message").textContent = KED_Dean.message;

const deanMessage = KED_Dean.message.split('\n').map(paragraph => `<p>${paragraph}</p>`).join('');

document.getElementById("dean-message").innerHTML = deanMessage;



document.getElementById("intro-text").textContent = KED_Intro;

document.getElementById("vision-title").textContent = KED_Overview.vision.title;
document.getElementById("vision-text").textContent = KED_Overview.vision.text;
document.getElementById("vision-image").src = KED_Overview.vision.image;

document.getElementById("objectives-title").textContent = KED_Overview.objectives.title;
const objectivesList = document.getElementById("objectives-list");
KED_Overview.objectives.list.forEach((item) => {
    const li = document.createElement("li");
    li.textContent = item;
    objectivesList.appendChild(li);
});
document.getElementById("objectives-image").src = KED_Overview.objectives.image;

document.getElementById("mission-title").textContent = KED_Overview.mission.title;
document.getElementById("mission-text").textContent = KED_Overview.mission.text;
document.getElementById("mission-image").src = KED_Overview.mission.image;
...
function createStaffCards(staffData, containerId) {
  ...
  createStaffCards(KED_Admin, "kedAdmin");
  createStaffCards(KED_Academic, "kedAcademic");
...
boxes.forEach(box => {
  box.addEventListener('click', () => {
    ...
    const correspondingCourses = KED_Courses.filter(course => course.label === boxLabel);
...
document.querySelector('.courses-table tbody').innerHTML = generateTableRows(KED_Courses);
