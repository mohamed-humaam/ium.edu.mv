...
document.getElementById("dean-name").textContent = DOS_Dean.name;
document.getElementById("dean-title").textContent = DOS_Dean.title;
document.getElementById("dean-department").textContent = DOS_Dean.department;
document.getElementById("dean-photo").src = DOS_Dean.photo;
document.getElementById("dean-phone").href = "tel:" + DOS_Dean.phone;
document.getElementById("dean-phone").lastChild.textContent = DOS_Dean.contact;
document.getElementById("dean-email").href = "mailto:" + DOS_Dean.email;
document.getElementById("dean-email").lastChild.textContent = DOS_Dean.email;
document.getElementById("dean-website").href = DOS_Dean.website;
document.getElementById("dean-website").lastChild.textContent = DOS_Dean.website;
document.getElementById("dean-message").textContent = DOS_Dean.message;

const deanMessage = DOS_Dean.message.split('\n').map(paragraph => `<p>${paragraph}</p>`).join('');

document.getElementById("dean-message").innerHTML = deanMessage;



document.getElementById("intro-text").textContent = DOS_Intro;

document.getElementById("vision-title").textContent = DOS_Overview.vision.title;
document.getElementById("vision-text").textContent = DOS_Overview.vision.text;
document.getElementById("vision-image").src = DOS_Overview.vision.image;

document.getElementById("objectives-title").textContent = DOS_Overview.objectives.title;
const objectivesList = document.getElementById("objectives-list");
DOS_Overview.objectives.list.forEach((item) => {
    const li = document.createElement("li");
    li.textContent = item;
    objectivesList.appendChild(li);
});
document.getElementById("objectives-image").src = DOS_Overview.objectives.image;

document.getElementById("mission-title").textContent = DOS_Overview.mission.title;
document.getElementById("mission-text").textContent = DOS_Overview.mission.text;
document.getElementById("mission-image").src = DOS_Overview.mission.image;
