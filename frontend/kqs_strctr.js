...
document.getElementById("dean-name").textContent = KQS_Dean.name;
document.getElementById("dean-title").textContent = KQS_Dean.title;
document.getElementById("dean-department").textContent = KQS_Dean.department;
document.getElementById("dean-photo").src = KQS_Dean.photo;
document.getElementById("dean-phone").href = "tel:" + KQS_Dean.phone;
document.getElementById("dean-phone").lastChild.textContent = KQS_Dean.contact;
document.getElementById("dean-email").href = "mailto:" + KQS_Dean.email;
document.getElementById("dean-email").lastChild.textContent = KQS_Dean.email;
document.getElementById("dean-website").href = KQS_Dean.website;
document.getElementById("dean-website").lastChild.textContent = KQS_Dean.website;
document.getElementById("dean-message").textContent = KQS_Dean.message;

const deanMessage = KQS_Dean.message.split('\n').map(paragraph => `<p>${paragraph}</p>`).join('');

document.getElementById("dean-message").innerHTML = deanMessage;



document.getElementById("intro-text").textContent = KQS_Intro;

document.getElementById("vision-title").textContent = KQS_Overview.vision.title;
document.getElementById("vision-text").textContent = KQS_Overview.vision.text;
document.getElementById("vision-image").src = KQS_Overview.vision.image;

document.getElementById("objectives-title").textContent = KQS_Overview.objectives.title;
const objectivesList = document.getElementById("objectives-list");
KQS_Overview.objectives.list.forEach((item) => {
    const li = document.createElement("li");
    li.textContent = item;
    objectivesList.appendChild(li);
});
document.getElementById("objectives-image").src = KQS_Overview.objectives.image;

document.getElementById("mission-title").textContent = KQS_Overview.mission.title;
document.getElementById("mission-text").textContent = KQS_Overview.mission.text;
document.getElementById("mission-image").src = KQS_Overview.mission.image;
